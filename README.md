...
O propósito da `Branch dev` é desenvolver novas features:
        Exemplos:
        - nova lógica SCD2
        - testar transformações (Bronze → Silver → Gold)
        - ajustar notebooks
        - Jobs do Databricks,
        - validar performance e regras de qualidade.
```

> Ela funciona como um ambiente seguro, onde mudanças podem ser feitas sem impactar a produção.
